...
??? question "How do I cite `clarid-tools`?"
    ...
    !!! Note "Citation"
        Manuel Rueda and Ivo G. Gut (2025). ClarID: A Human-Readable and Compact Identifier Specification for Biomedical Metadata Integration. _Journal of Biomedical Sematics_.
