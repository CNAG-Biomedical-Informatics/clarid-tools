...
See
[`utils/csv/gdc_biosample_mapping.yaml`](https://github.com/CNAG-Biomedical-Informatics/clarid-tools/blob/main/utils/csv/gdc_biosample_mapping.yaml).
...
[`nb/data/biosample/clarid_human.csv.gz`](https://github.com/CNAG-Biomedical-Informatics/clarid-tools/tree/main/nb/data/biosample/clarid_human.csv.gz).

<CsvDataTable
  src="/data/biosample/clarid_human.csv.gz"
  label="biosample encodings"
  initialPageSize={10}
/>
