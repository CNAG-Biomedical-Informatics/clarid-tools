...
Use this page when you know what you want to run and need the exact option
names, accepted values, and command shape.

<div class="claridCommandMap">
  <a href="#-clarid-tools-code-options">
    <span>code</span>
    <strong>Encode and decode</strong>
    <small>Identifiers, CSV input/output, formats, entities, and codebooks.</small>
  </a>
  <a href="#-clarid-tools-validate-options">
    <span>validate</span>
    <strong>Validate codebooks</strong>
    <small>Check YAML codebooks and optional schema paths.</small>
  </a>
  <a href="#-clarid-tools-qrcode-options">
    <span>qrcode</span>
    <strong>Generate QR codes</strong>
    <small>Encode CSV values to PNGs or decode QR images back to CSV.</small>
  </a>
</div>
...
<summary>Before You Run Commands</summary>
